<template>
  <img
    :src="`https://image.tmdb.org/t/p/${size}${result.posterPath}`"
    alt="poster"
    class="transition ease-in-out duration-400 hover:opacity-80"
    v-if="size != 'w45' && result.posterPath && my_key == 'poster_path'"
  />
  <img
  ...
  />
  <img
    v-if="size == 'w45' && my_key == 'poster_path' && !result.posterPath"
